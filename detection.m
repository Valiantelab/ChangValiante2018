...
%% Remove artifacts based on peak-to-peak amplitude
...
clear indexEvents
if featureSet (indexArtifact)
    events (indexArtifact, 7) = 4;  %4 = event contains an artifact    
end
