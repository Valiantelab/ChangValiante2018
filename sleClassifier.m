function [index,featureThreshold ] = sleClassifier(featureSet,plotGraph)
...
index = kmeans(featureSet, k);

% finding the threshold
groupSLE = featureSet(index ==1); %SLEs are labelled 1
groupIIE = featureSet(index ==2); %SLEs are labelled 2
