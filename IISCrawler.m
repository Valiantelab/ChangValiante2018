...
%     subplot (2,1,1)
%     plot(t(onsetContext),LFP(onsetContext))
%     hold on
%     plot(t(onsetSLE), LFP(onsetSLE), 'x', 'color', 'red', 'MarkerSize', 12)  %initial (rough) detection
%     plot(SLEonset_final(i,1), LFP(onsetContext(onset_locs(1))), 'o', 'color', 'black', 'MarkerSize', 14)   %Detected onset point 
%     plot(t(onsetContext(onset_locs)), LFP(onsetContext(onset_locs)), '*', 'color', 'green', 'MarkerSize', 14)    %All potential detected onset points
%     
...
%     close(figHandle)
    ...
    plot(SLEoffset_final_Abs(i,1), LFP(offsetContext(offset_loc)), 'o', 'color', 'black', 'MarkerSize', 14)   %Detected offset point 
    plot(t(offsetContext(offset_loc)), LFP(offsetContext(offset_loc)), '*', 'color', 'green', 'MarkerSize', 14)    %All detected potential offsets    
    %Labels
