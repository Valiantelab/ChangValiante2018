...
% .abf file to analyze. For full details, read the documentation provided.
...
if (InputGUI(6)=="")
    ...
    [spikes, events, SLE, details] = detectionAlgorithm(FileName, userInput, x, samplingInterval, metadata);
else
